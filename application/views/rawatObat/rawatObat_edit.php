    ...
    <div class="row">
        <div class="card">
            <div class="card-body">
                ...
                <form method="POST" action="<?php echo base_url('rawatobat/update/' . $detail['idrawatobat']) ?>">

                    <label for="idrawatobat">ID Rawat Obat : </label><input type="text" class="form-control" name="idrawatobat" value="<?php echo $detail['idrawatobat'] ?>" placeholder="Format ID : MR0XX">
                    ...
                    <label for="jumlah">Jumlah : </label><input type="number" class="form-control" name="jumlah" value="<?php echo $detail['jumlah'] ?>">
